...
line("Patient release", "new onboarding/home/request UX needs signed build verification");
...
console.log("");
console.log("Before the next Patient TestFlight upload:");
console.log("  apply the reviewed patient-access migration and deploy its API route");
console.log("  run signed archive validation and a focused patient regression pass");
